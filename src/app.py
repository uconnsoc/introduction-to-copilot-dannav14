...
activities = {
    ...
    "Soccer Club": {
        "description": "Team practices and friendly matches on the school field",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 22,
        "participants": ["liam@mergington.edu", "ava@mergington.edu"]
    },
    "Basketball Team": {
        "description": "Develop basketball skills and compete in interschool games",
    ...
    "Music Ensemble": {
        "description": "Perform instrumental and vocal music together",
    ...
    "Science Club": {
        "description": "Explore experiments, scientific topics, and research projects",
